...
export default function PrivacyPolicy() {
  return (
    <div className="container my-5 px-3" style={{ maxWidth: '800px' }}>
      ...
      <p>En EasyFlights valoramos tu privacidad. Esta política explica cómo recopilamos, usamos y protegemos tu información personal cuando usas nuestra plataforma.</p>
